    ...
    return (
      ...
      >
        ...
        >
          ...
          <h2 className="quiz-result-title">{result.personality_type} 🎉</h2>

          <p className="ai-source-label">
            Generated by <strong>Gemini AI</strong> 🤖 • {new Date().toLocaleString()}
          </p>
          ...
          <ul className="quiz-hobby-list">
            {(result.strengths || []).map((s, idx) => (
              <li key={idx} className="quiz-hobby-item">✨ {s}</li>
            ))}
          </ul>
